...
const Nav = () => {
  ...
  return (
    <div className='w-[100vw] flex justify-evenly h-16 items-center fixed bg-white text-black'>
     <p className='font-extrabold font-serif'>cyber</p>
     <div className='flex items-center sm:ml-5 sm:mr-5 w-auto text-black'>
